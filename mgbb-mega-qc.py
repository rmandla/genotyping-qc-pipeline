...
ancestry_matrix = {'EU':['W'],'HIS':['H'],'AFR':['B'],'AS':['A'],'Other':['O','']}
pheno_files = ['file1.bin.txt','file2.bin.txt','file3.bin.txt','file4.bin.txt','file5.bin.txt','file6.bin.txt','file7.bin.txt','file8.bin.txt']
