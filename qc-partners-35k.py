...
plink2 = '/humgen/diabetes/users/josep/apps/plink2/plink'
directory = '/humgen/diabetes2/users/josep/PartnersBIOBANK/merge_all_35K_datasets/merge_35K_genotypes/'
data="PHBB_SNPs_35K"
data_dir = directory + data
ancestries=['EU','HIS','AFR','AS','Other']
...
#filter_tables()
#filter_individual_snps()
#sex_check()
#check_relatedness()
#extract_nonGCAT()
#reformat_bim(data+'.clean.snps1.mind.0.02.sexcheck_het_out_unrelated.bim',output=data+'_new_bim_for_merge1000G.bim',format='concat')
#reformat_bim("/humgen/diabetes/users/josep/PartnersBIOBANK/phase3.pruned.bim",output='1000G_chr_pos_alleles.bim',format='concat')
#prep_for_mds()
#filter_from_mds()
#identify_gcats()
prep_frequency_file('.clean.snps1.mind.0.02.sexcheck_het_out_no_outliers.clean.snps2_no_GCATs')
